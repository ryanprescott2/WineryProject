...
static void RTC_EveryMinuteHandler(void)
{
    ...
    static uint8 minuteCounter = 0;
    minuteCounter++;
    if (minuteCounter == waitMinutes)
    {
        minuteCounter = 0;
        wake_flag = 1;
        waitMinutes = WAKE_INTERVAL;
    }
    
    /*This is the start of the bat test code*/   
    /*static uint8 batCounter = 0;
    batCounter++;
    if (batCounter == 6){
        sync_flag = true;
        batCounter = 0;
    }*/
    /*This is the end of the bat test code remove when done and set sync flag high in everyday hadl*/
...
static void RTC_EveryDayHandler(void)
{
    ...
    sync_flag = true;    //This is where clock sync should go
